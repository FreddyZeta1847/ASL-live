...
- **[phases/phase-1-data-collection.md](phases/phase-1-data-collection.md)** —
  ...
  Approved 2026-04-29. **Shipped.**
- **[phases/phase-2-training.md](phases/phase-2-training.md)** —
  implementation plan for PLAN.md phase 2. 6 commits: dataset → augment →
  model + train loop → metrics → ONNX export → classifier wrapper, with
  an `ml-python-expert` review pass before export. Approved 2026-05-08.
